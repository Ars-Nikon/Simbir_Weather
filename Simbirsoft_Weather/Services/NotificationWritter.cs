    ...
    public class NotificationWritter : INotificationWritter
    {
            ...
            string userName)
        {
            return ForManOrWoman(
                ...
                weatherForTime[weatherForTime.Keys.Take(1).First()].Wind.Deg / 10d,
                weatherForTime[weatherForTime.Keys.Take(1).First()].WeatherDescriptions[0].Description,
                weatherForTime[weatherForTime.Keys.Skip(1).First()].Wind.Deg / 10d,
                weatherForTime[weatherForTime.Keys.Skip(1).First()].WeatherDescriptions[0].Description,
                weatherForTime[weatherForTime.Keys.Skip(2).First()].Wind.Deg / 10d,
                weatherForTime[weatherForTime.Keys.Skip(2).First()].WeatherDescriptions[0].Description,
                weatherForTime[weatherForTime.Keys.Skip(3).First()].Wind.Deg / 10d,
                weatherForTime[weatherForTime.Keys.Skip(3).First()].WeatherDescriptions[0].Description,
                weatherForTime[weatherForTime.Keys.Skip(4).First()].Wind.Deg / 10d,
                weatherForTime[weatherForTime.Keys.Skip(4).First()].WeatherDescriptions[0].Description,
                "Мужчина",
                _clothesName[ClothesType.Head],
